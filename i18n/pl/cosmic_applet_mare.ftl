# Authentication
sign-in = Zaloguj się przez TIDAL
sign-in-prompt = Zaloguj się, aby uzyskać dostęp do muzyki
sign-in-title = Zaloguj się do TIDAL
...
song-cache = Pamięć podręczna utworów:
song-cache-size = {$used} MB / {$max} MB
song-cache-limit = Limit pamięci podręcznej utworów:
clear-cache = Wyczyść
account = Konto
about = O programie
version = Wersja
...
# Share
share = Udostępnij
share-description = Wygeneruj link song.link i skopiuj do schowka

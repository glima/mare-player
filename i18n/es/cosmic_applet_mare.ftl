# Autenticación
sign-in = Iniciar sesión con TIDAL
sign-in-prompt = Inicia sesión para acceder a tu música
sign-in-title = Iniciar sesión en TIDAL
...
quality-lossless = Sin pérdida (calidad CD)
quality-hires = Alta resolución (calidad máster)
quality-description-low = 96 kbps AAC - Usa menos datos
quality-description-high = 320 kbps AAC - Buena calidad
quality-description-lossless = FLAC 16-bit/44,1kHz - Calidad CD
quality-description-hires = FLAC hasta 24-bit/192kHz - Calidad máster (requiere HiFi Plus)
cache = Caché
song-cache = Caché de canciones:
song-cache-size = {$used} MB / {$max} MB
song-cache-limit = Límite de caché de canciones:
clear-cache = Limpiar
account = Cuenta
about = Acerca de
version = Versión
...
# Compartir
share = Compartir
share-description = Generar una URL de song.link y copiar al portapapeles
